...
export const OrderCard = memo(
  ({
    ...
    <motion.div
      ...
      className={`bg-white p-5 rounded-[2.2rem] border-2 shadow-sm group hover:shadow-xl hover:shadow-gray-200/50 transition-all duration-300 ${config?.border || "border-gray-100"} shrink-0 w-full`}
    >
      ...
      <button
        onClick={() => onUpdate && onUpdate(order.id, status)}
